...
do{
	...
	$hd=99;
	switch($hand){
		case "Royal Flush":     $win=$total_bet*251; $hd=0; if($total_bet==5){ $win=2000; }; break;
		case "Strait Flush":    $win=$total_bet*51;  $hd=1; break;
		case "Four of a kind":  $win=$total_bet*26;  $hd=2; break;
		case "Full House":      $win=$total_bet*10;  $hd=3; break;
		case "Flush":           $win=$total_bet*7;   $hd=4; break;
		case "Strait":          $win=$total_bet*5;   $hd=5; break;
		case "Three of a kind": $win=$total_bet*4;   $hd=6; break;
		case "Two Pair":        $win=$total_bet*3;   $hd=7; break;
		case "Jacks or Better": $win=$total_bet*2;   $hd=8; break;
	}
	$diff=$win-$total_bet;
