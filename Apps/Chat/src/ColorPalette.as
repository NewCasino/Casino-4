package {
	...
	public class ColorPalette extends Sprite {
		...
		public function ColorPalette() {
			...
			paletteList.x = openButton.width;
			paletteList.y = -100;// openButton.height + 30;
		...
		private function openButtonClickHandler(e:MouseEvent):void {
			if (paletteList.visible) {				
				...
				paletteList.x = -paletteList.width;
				paletteList.y = -paletteList.height + 15;
				paletteList.show();				
			}
