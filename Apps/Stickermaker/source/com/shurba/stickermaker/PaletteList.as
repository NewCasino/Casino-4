package com.shurba.stickermaker {
	...
	public class PaletteList extends Sprite {
		...
		public function PaletteList() {
			...
			chbPreview = new CheckBox();
			chbPreview.label = "Preview";
			//chbPreview.textField.defaultTextFormat = new TextFormat("Times New Roman", 10);			
			this.addChild(chbPreview);
			chbPreview.x = 10;
			chbPreview.y = 21;
			chbPreview.selected = true;			
			this.addListeners();
		}
		
		private function addListeners():void {
			chbPreview.addEventListener(Event.CHANGE, boxPreviewChangeHandler, false, 0, true);
		}
		...
		private function boxPreviewChangeHandler(e:Event):void {
			enabled = (e.currentTarget as CheckBox).selected;
			this.dispatchEvent(new Event("previewStateChange"));
		...
		private function updateDisplayList():void {
			...
			chbPreview.width -= 25;
			chbPreview.x = this.width - chbPreview.width;
			chbPreview.y = 21;
