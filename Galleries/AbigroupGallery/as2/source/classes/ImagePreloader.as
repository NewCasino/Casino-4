...
class classes.ImagePreloader extends MovieClip {
	...
	private var IMAGE_WIDTH:Number = 963;
	private var IMAGE_HEIGHT:Number = 348;
	...
	public function ImagePreloader() {
		...
		tintMask.moveTo(0, 0);
		tintMask.lineTo(IMAGE_WIDTH, 0);
		tintMask.lineTo(IMAGE_WIDTH, IMAGE_HEIGHT);
		tintMask.lineTo(0, IMAGE_HEIGHT);
		tintMask.lineTo(0, 0);	
		tintMask.endFill();
	...
	public function onResize():Void {
		...
		imageContainer._width = IMAGE_WIDTH;
		imageContainer._height = IMAGE_HEIGHT;
		tintMask._width = IMAGE_WIDTH;
		tintMask._height = IMAGE_HEIGHT
