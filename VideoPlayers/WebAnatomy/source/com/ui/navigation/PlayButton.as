package com.ui.navigation {
	...
	public class PlayButton extends MovieClip {
		...
		public function PlayButton() {
			...
			mcPlayBtn.alpha = 0.5;
			mcPlayBtn.sdtLabel.mouseEnabled = false;
			this.updateTexts();
		}
		...
		public function updateTexts():void {
			mcPlayBtn.sdtLabel.text = dataHolder.xMainXml.buttonsname.play_btn.@value;
		}
		...
		private function rollOverHandler($event:MouseEvent):void {			
			TweenLite.to(mcPlayBtn, 0.5, {alpha:1});
		}
		
		private function rollOutHandler($event:MouseEvent):void {
			TweenLite.to(mcPlayBtn, 0.5, {alpha:0.75});
		}
	}
