package com{
	class ClassVideo{
		...
		public function myVideo_whenvideoload(){
			...
			root.video_layer.x = root.stage.stageWidth/2  - root.video_layer.width/2
			root.video_layer.y = root.stage.stageHeight/2 - root.video_layer.height/2 -root.navigation_mc.bottom_navigation.height/2
		}
