package com {
	...
	public class AdaptvPlayer extends Sprite{	
		...
		public function AdaptvPlayer(config:Object, callback:Object, adaptvintegrate:String = undefined):void {	
			...
			var adPlayerLoadingTimer:Timer = new Timer(3000, 1);
		 ...
		 */
		public function initialize(config:Object, callback:Object):void {
			this.config = config;
			this.callback = callback;
			shouldCallInitialize = true;
			sendInitData();
		...
		public function setSize(width:Number, height:Number):void {
			if (!isLoaded){
 			...
 			sendConnection.send(sendConnName, "setSize", width, height);	
		}	
		...
		private function onSetStatus(event:TimerEvent) {  
